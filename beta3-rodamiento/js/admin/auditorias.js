...
window.verReporteAnalizado = function (index) {
    ...
    if (modalElement) {
        ...
        if (modalContent) {
            ...
            // Render image in cloned content - Carousel interactivo para 1 o múltiples fotos
            const clonedSoporteContainer = contentClone.querySelector('#viewSoporteContainer');
            const soporteUrl = rep.soporte || rep.SOPORTE || '';
            renderImageCarousel(soporteUrl, clonedSoporteContainer, { customClick: 'openImageModal' });
...
// ── Helper Carrusel interactivo para 1 o múltiples imágenes ──
