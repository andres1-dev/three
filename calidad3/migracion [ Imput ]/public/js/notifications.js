    ...
    toast.innerHTML = `
        ...
        <div style="flex:1;min-width:0;">
            <div style="font-weight:800;font-size:0.8rem;color:#1e293b;margin-bottom:2px;">
                Lote ${nov.ID || nov.LOTE || 'S/N'} — ${cfg.label}
            </div>
...
function _renderNotifList() {
    ...
    list.innerHTML = _notifications.map(n => {
        ...
        if (n.type === 'chat') {
            ...
            return `
                <div onclick="_openGuestChatFromNotif('${n.nov.ID_NOVEDAD}','${(n.nov.PLANTA||'').replace(/'/g,"\\'")}','${(n.nov.ID||n.nov.LOTE||'').replace(/'/g,"\\'")}','${n.id}')"
                    ...
                    <div style="flex:1;min-width:0;">
                        <div style="font-weight:700;font-size:0.78rem;color:#1e293b;margin-bottom:2px;">
                            Nuevo mensaje — Novedad ${n.nov.ID_NOVEDAD || 'S/N'}
                        </div>
...
/* ── Auto-Inicializar Panel para Todos los Roles ── */
