...
/* ── Supabase ─────────────────────────────────────────────────────────────── */
const SUPABASE_URL = 'https://efocfgjunowtkrgxepbn.supabase.co';
...
const SHEET_NOVEDADES = Object.freeze({
    ...
    headers: ['id_novedad', 'fecha', 'id', 'referencia', 'cantidad', 'planta', 'salida', 'cuento', 'proceso', 'prenda', 'genero', 'area', 'tipo_novedad', 'tipo_detalle', 'descripcion', 'cantidad_solicitada', 'imagen', 'estado', 'chat', 'chat_read', 'historial_estados', 'comentarios', 'cobro', 'productora'],
});
...
const SHEET_REPORTES = Object.freeze({
    ...
    headers: ['ID_REPORTE', 'FECHA', 'ID', 'REFERENCIA', 'CANTIDAD', 'PLANTA', 'SALIDA', 'LINEA', 'PROCESO', 'PRENDA', 'GENERO', 'TEJIDO', 'EMAIL', 'LOCALIZACION', 'TIPO_VISITA', 'CONCLUSION', 'OBSERVACIONES', 'SOPORTE', 'PRODUCTORA'],
});
