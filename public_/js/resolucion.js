...
<body>
    ...
    <script>
        ...
        function updateCharts() {
                ...
                options: { 
                    ...
                    onClick: (evt, elements) => {
                        if (elements.length > 0) {
                            ...
                            // Toggle: si ya estaba seleccionado, se deselecciona (vuelve a Global)
            ...
            // --- 2. PROCESAR PESO VOLUMÉTRICO POR ÁREA ---
            // Filtrar por la semana seleccionada si existe, sino usar todo el set filtrado
            const areaData = activeWeek 
                ? filteredData.filter(n => "Sem " + getISOWeek(new Date(n.FECHA)) === activeWeek)
                : filteredData;
            ...
            const totalAreaUnits = Object.values(areaMap).reduce((s, v) => s + v, 0);
            const labelsWithPerc = Object.keys(areaMap).map(k => {
