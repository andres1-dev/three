...
self.addEventListener('push', event => {
  console.log('[SW] ✅ Push recibido (Supabase Web Push)');
  ...
  try {
    ...
    if (event.data) {
      try {
        ...
        console.log('[SW] Payload Web Push recibido:', payload);
...
async function _showSupabasePush(payload) {
  ...
  const icon = payload.icon || './icons/TDM_variable_colors.svg';
  const badge = payload.badge || './icons/TDM_variable_colors.svg';
