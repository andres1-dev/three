  ...
  try {
    ...
    switch (accion) {
      case "REPORTE_CALIDAD": {
        ...
        // NOTA: Los correos automáticos están estrictamente prohibidos para los reportes de calidad.
        // El envío se realiza de forma explícita por el usuario desde la interfaz de Mis Reportes.
