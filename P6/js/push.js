...
window.triggerPwaNotification = function(title, body, tag, url) {
  if (!_swRegistration || Notification.permission !== 'granted') return;
  _swRegistration.showNotification(title || 'SISPRO', {
    body:    body || '',
    icon:    './icons/TDM_variable_colors.svg',
    badge:   './icons/TDM_variable_colors.svg',
    vibrate: [200, 100, 200],
    tag:     tag || 'sispro-dynamic',
...
/* ══════════════════════════════════════════════════════════════════════════
   Init automático DESACTIVADO - Ahora se usa push-supabase.js
   ══════════════════════════════════════════════════════════════════════════ */
/*
(function initPush() {
...
console.log('[PUSH.JS] Sistema antiguo desactivado - Usando push-supabase.js');
