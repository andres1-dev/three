...
/* ==========================================================================
   Inicialización de Notificaciones Push con Supabase
   ========================================================================== */

/**
 * VAPID Public Key para Web Push API
 * Esta key es pública y puede estar en el código del cliente
 */
const VAPID_PUBLIC_KEY = 'MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEMUTkkkISEH7rI9lCSvaSK4uxyfpcDH_SQL5Pm663bMaOeNvLmjta8ABCz5u3cdWj8rfWl8mRxj2aMNnMSHtjQA';

/**
 * Inicializa el sistema de notificaciones push cuando el DOM esté listo
 */
function initPushNotifications() {
    // Verificar que PushSupabase esté disponible y el navegador soporte push
    if (!window.PushSupabase || !PushSupabase.isSupported()) {
        console.log('[PUSH] Notificaciones push no disponibles en este navegador');
        return;
    }

    // Configuración de Supabase
    const SUPABASE_URL = 'https://doqsurxxxaudnutsydlk.supabase.co';
    const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRvcXN1cnh4eGF1ZG51dHN5ZGxrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzU3MjExMDUsImV4cCI6MjA5MTI5NzEwNX0.yKcRgTad3cb2otQ7wtjkRETj3P-3THb9v8csluebALg';

    // Inicializar PushSupabase
    PushSupabase.init(SUPABASE_URL, SUPABASE_ANON_KEY, VAPID_PUBLIC_KEY);
    
    console.log('[PUSH] ✅ Sistema de notificaciones Supabase inicializado');
}
...
async function activarNotificaciones() {
    if (!window.PushSupabase) {
        console.error('[PUSH] PushSupabase no está disponible');
        return false;
    }
...
window.enviarNotificacionPrueba = enviarNotificacionPrueba;
